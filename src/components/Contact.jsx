      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-16 pb-20">
        ...
        <div className="mt-8 grid gap-10 lg:grid-cols-3">
          ...
          <div className="space-y-4 my-auto">
            ...
            >
              <span className="inline-flex h-9 w-9 items-center justify-center rounded-md bg-slate-900 border border-slate-800  hover:shadow-[0_0_0_2px_rgb(45_212_191/80%),0_0_30px_-10px_rgb(34_211_238/100%)]">
            ...
            <a
              ...
              className="group flex items-center gap-3 text-slate-300 hover:text-white"
            >
              <span className="inline-flex h-9 w-9 pl-0.5 pb-0.5 items-center justify-center rounded-md bg-slate-900 border border-slate-800  hover:shadow-[0_0_0_2px_rgb(45_212_191/80%),0_0_30px_-10px_rgb(34_211_238/100%)]">
          ...
          >
            ...
            <div className="mt-4">
              ...
              />
              <div className="flex justify-center mt-2 text-slate-300">{message.length} / 500</div>
            </div>
            <div className="flex justify-center mt-5">
              <motion.button
                type="submit"
                className="inline-flex justify-center items-center gap-2 w-1/3 rounded-md bg-gradient-to-r from-teal-400 to-cyan-400 
                px-5 py-2.5 text-slate-900 font-medium shadow-glow hover:opacity-95 focus-visible:outline-none 
                ...
                whileTap={{ scale: 0.92 }}
              >
                <span className="pb-1">Envoyer</span>
                <svg
                  aria-hidden="true"
                  className="h-5 w-5"
                  fill="none"
